        ...
        if len(datos) == 10:
            ...
            if len(respuesta)>0:
                ...
                if fecha_salida == None:
                   ...
                   ### Label con mensaje de Boleto re-usado, No abre Barrera
                   self.descripcion.set('Boleto Obsoleto, auto afuera')
                   self.precio.set('')
                   self.folio.set("")
                   self.entryfolio.focus()                    
                else:   
                    ...
                    #para no ser re-usado para salir
                    estatus=("Afuera",datos)
                    self.operacion1.ActualizaSalida(estatus)
            ...
            #self.entryfolio.focus()
    ###PENSIONADOS
    def PensionadosOut(self,event): ##Actualizo el 16julio22
